...
class ReorderExtension < Radiant::Extension
  ...
  def activate
    ...
    (Admin::PagesController rescue Admin::PageController).send :include, Reorder::PagesControllerExtensions
    (Admin::PagesController rescue Admin::PageController).send :helper, Reorder::PageHelper
